...
const ticketEmbed = (userName, userId, paymentInfo, paymentMethod) => {
    const status = paymentMethod === 'paysafe' ? 'Paysafe Code eingereicht' : 'PayPal überwiesen';
    ...
    return new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: 'Nachricht', value: '✅ Wir überprüfen die Zahlung und melden uns schnellstmöglich bei Ihnen!', inline: false }
        )
        .setColor('#2b2d31')
        .setTimestamp()
